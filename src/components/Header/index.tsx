...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`ud-header left-0 top-0 z-40 flex w-screen items-center ${
          sticky
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                <button
                  ...
                  className="absolute  top-1/2 block -translate-y-1/2 rounded-lg  py-[6px] ring-secondary focus:ring-2 lg:hidden"
                >
                  <span
                        ...
                        <li className="submenu-item group relative" key={index}>
                          {pathUrl !== "/" ? (
                            <button
                              ...
                              className={`ud-menu-scroll flex items-center justify-between py-2 text-base text-dark group-hover:text-secondary dark:text-white dark:group-hover:text-secondary lg:inline-flex lg:px-0 lg:py-6`}
                            >
                              {menuItem.title}
                              ...
                              <Link
                                ...
                                className={`block rounded px-4 py-[10px] text-sm ${
                                  pathUrl === submenuItem.path
                                    ? "text-secondary"
                                    : "text-body-color hover:text-secondary dark:text-dark-6 dark:hover:text-secondary"
                                }`}
                              >
                                {submenuItem.title}
                              </Link>
                ...
                {session?.user ? (
                  <>
                    ...
                    {pathUrl !== "/" || sticky ? (
                      <button
                        onClick={() => signOut()}
                        className="signUpBtn rounded-lg bg-secondary bg-opacity-100 px-6 py-3 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-20 hover:text-dark"
                      >
                        Sign Out
                      </button>
                    ) : (
                  ...
                  <>
                    {pathUrl !== "/" ? (
                      <>
                        ...
                        <Link
                          href="/signup"
                          className="rounded-lg bg-secondary px-6 py-3 text-base font-medium text-white duration-300 ease-in-out hover:bg-primary/90 dark:bg-white/10 dark:hover:bg-white/20"
                        >
                          Sign Up
                        </Link>
                      </>
